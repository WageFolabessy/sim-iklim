...
<div class="min-h-screen bg-background">
    ...
    <section class="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        <form method="POST" action="{{ route('citizen-reports.store') }}" novalidate class="rounded-2xl border border-border bg-card p-6 shadow-card sm:p-8"
            ...
            <button
                type="submit"
                class="cursor-pointer mt-6 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground shadow-glow transition hover:opacity-90"
            >
